...
class StudentController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('administrator.students.index', compact('data', 'classrooms', 'academicYears'));
    }
    ...
    public function create()
    {
        $classrooms = Classroom::all();
        $academicYears = AcademicYear::all();
        return view('administrator.students.create', compact('classrooms', 'academicYears'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('administrator.students.index')->with('success', 'Siswa baru berhasil ditambahkan');
    }
    ...
    {
        $classrooms = Classroom::all();
        return view('administrator.students.edit', compact('student', 'classrooms'));
    }
    ...
    public function update(Request $request, Student $student)
    {
        ...
        return redirect()->route('administrator.students.index')->with('success', 'Data siswa berhasil diperbarui');
    }
    ...
    public function destroy(Student $student)
    {
        ...
        return redirect()->route('administrator.students.index')->with('success', 'Data siswa berhasil dihapus');
    }
