...
class ClassroomController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('administrator.classrooms.index', compact('data', 'teachers'));
    }
    ...
    public function create()
    {
        $teachers = User::where('role_id', 3)
                    ...
                    ->get();   
        return view('administrator.classrooms.create', compact('teachers'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('administrator.classrooms.index')->with('success', 'Kelas baru berhasil ditambahkan');
    }
    ...
    public function edit(Classroom $classroom)
    {
        $teachers = User::where('role_id', 3)
                        ...
                        ->get();   
        return view('administrator.classrooms.edit', compact('classroom', 'teachers'));
    }
    ...
    public function update(Request $request, Classroom $classroom)
    {
        ...
        return redirect()->route('administrator.classrooms.index')->with('success', 'Kelas berhasil diperbarui');
    }
    ...
    public function destroy(Classroom $classroom)
    {
        ...
        return redirect()->route('administrator.classrooms.index')->with('success', 'Kelas berhasil dihapus');
    }
