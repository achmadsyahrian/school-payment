...
class AcademicYearController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('employee.academic_years.index', compact('data'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('employee.academicyears.index')->with('success', 'Tahun ajaran baru berhasil ditambahkan');
    }
