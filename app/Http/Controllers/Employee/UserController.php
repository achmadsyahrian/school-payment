...
class UserController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('employee.users.index', compact('data'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('employee.users.index')->with('success', 'Pegawai baru berhasil ditambahkan');
    }
    ...
    public function update(Request $request, User $user)
    {
        ...
        return redirect()->route('employee.users.index')->with('success', 'Data pegawai berhasil diperbarui');
    }
    ...
    public function destroy(User $user)
    {
        ...
        return redirect()->route('employee.users.index')->with('success', 'Data pegawai berhasil dihapus');
    }

    private function searchUsers(Request $request)
    {
        $query = User::where('role_id', 2)->whereNotIn('id', [auth()->id()]);
