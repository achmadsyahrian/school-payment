   ...
   <div class="section-body">
      ...
      <div class="row mt-sm-4">
         <div class="col-12 col-md-12 col-lg-12">
            <div class="card">
               <form action="{{ route('teacher.students.update', [$student]) }}" method="post" enctype="multipart/form-data" novalidate="">
                  @method('patch')
                  @csrf
                     ...
                     <div class="row">
                        <div class="form-group col-md-3 col-12">
                           ...
                           <select class="form-control selectric" name="gender">
                              ...
                              <option value="Laki-Laki" {{ old('gender') == 'Laki-Laki' || (isset($student) && $student->gender == 'Laki-Laki') ? 'selected' : '' }}>Laki Laki</option>
                              <option value="Perempuan" {{ old('gender') == 'Perempuan' || (isset($student) && $student->gender == 'Perempuan') ? 'selected' : '' }}>Perempuan</option>
                           </select>
                           @error('gender')
                           <div class="form-text text-danger">{{ $message }}</div>
                           @enderror
