...
<div class="section">
   ...
   <div class="section-body">
      ...
      <p class="section-lead">
         Silakan perbarui informasi wali kelas <span class="text-primary">{{ $user->name }}</span> di bawah ini sesuai dengan perubahan yang diinginkan
      </p>

      <div class="row mt-sm-4">
         <div class="col-12 col-md-12 col-lg-12">
            <div class="card">
               <form action="{{ route('administrator.teachers.update', [$user]) }}" method="post" enctype="multipart/form-data" novalidate="">
                  @method('patch')
                  @csrf
