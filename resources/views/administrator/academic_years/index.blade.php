...
@section('content')
    <div class="section">
        ...
        <div class="section-header">
            ...
            <div class="section-header-button">
                <a href="{{ route('administrator.academicyears.create') }}" class="btn btn-primary">Tambah</a>
            </div>
                        ...
                        <div class="card-body">
                            {{-- <div class="float-right">
                                <div class="input-group">
                                    ...
                                    <form action="{{ route('administrator.academicyears.index') }}" method="GET"
                                ...
                                <table class="table table-striped">
                                    ...
                                    @forelse ($data as $item)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{ route('administrator.academicyears.edit', [$item]) }}"
                                                    class="btn btn-primary btn-action mr-1" data-toggle="tooltip"
                                                    title="Edit"><i class="fas fa-pencil-alt"></i></a>
                                                <form class="d-inline"
                                                    action="{{ route('administrator.academicyears.destroy', $item) }}"
    ...
    {{-- @include('administrator.academicyears.modal') --}}
@endsection
