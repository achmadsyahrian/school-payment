...
<div class="section">
   ...
   <div class="section-header">
      <div class="section-header-back">
         <a href="{{ route('administrator.classrooms.index') }}" class="btn btn-icon"><i class="fas fa-arrow-left"></i></a>
      </div>
      <h1>Edit</h1>
      <div class="section-header-breadcrumb">
         <div class="breadcrumb-item active"><a href="/">Dashboard</a></div>
         <div class="breadcrumb-item active"><a href="{{ route('administrator.classrooms.index') }}">Kelas</a></div>
   ...
   <div class="section-body">
      ...
      <div class="row mt-sm-4">
         <div class="col-12 col-md-12 col-lg-12">
            <div class="card">
               <form action="{{ route('administrator.classrooms.update', [$classroom]) }}" method="post" enctype="multipart/form-data" novalidate="">
                  @method('patch')
                  @csrf
