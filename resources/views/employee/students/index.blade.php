...
<div class="section">
   ...
   <div class="section-body">
      ...
      <p class="section-lead">
         Anda bisa melihat seluruh daftar siswa <span class="text-primary">{{ config('app.name') }}</span> yg ada disini
      </p>
                        ...
                        @forelse ($data as $item)
                           <tr>
                             ...
                             <td>
                              ...
                              <td>
                                 <div class="d-flex align-items-center">
                                    @if ($item->classroom->teacher->photo)
                                       <img alt="image" src="{{ asset('storage/photos/user/' . $item->classroom->teacher->photo) }}" class="rounded-circle" style="object-fit: cover" width="35" height="35" data-toggle="title" title="">
                                    @else
                                       <img alt="image" src="{{ asset('assets/img/avatar/avatar-1.png') }}" class="rounded-circle" width="35" data-toggle="title" title="">
                                    @endif
                                     <div class="ml-3">
                                         <div>{{ $item->classroom->teacher->name }}</div>
                                         <div>
                                             Kontak : <a href="#">{{ $item->classroom->teacher->phone ?? '--' }}</a>
                                         </div>
                                     </div>
                                 </div>
                              </td>
