...
<div class="section">
   ...
   <div class="section-header">
      <div class="section-header-back">
         <a href="{{ route('employee.users.index') }}" class="btn btn-icon"><i class="fas fa-arrow-left"></i></a>
      </div>
      <h1>Tambah Pegawai</h1>
      <div class="section-header-breadcrumb">
         <div class="breadcrumb-item active"><a href="/">Dashboard</a></div>
         <div class="breadcrumb-item active"><a href="{{ route('employee.users.index') }}">Pegawai</a></div>
   ...
   <div class="section-body">
      ...
      <p class="section-lead">
         Lengkapi informasi berikut untuk mendaftarkan pegawai admin baru.
      </p>

      <div class="row mt-sm-4">
         <div class="col-12 col-md-12 col-lg-12">
            <div class="card">
               <form action="{{ route('employee.users.store') }}" method="post" enctype="multipart/form-data" novalidate="">
                  @csrf
