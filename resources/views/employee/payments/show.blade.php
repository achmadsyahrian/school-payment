...
<div class="section">
   ...
   <div class="section-header mb-5">
      <div class="section-header-back">
         <a href="{{ route('employee.payments.index') }}" class="btn btn-icon"><i class="fas fa-arrow-left"></i></a>
      </div>
      <h1>Pembayaran</h1>
               ...
               @foreach ($academicYears as $item)
                  <div class="col-12 col-md-6 col-lg-3">
                     <div class="card {{ $item->isComplete ? 'card-success' : 'card-primary' }}">
                           ...
                           <div class="card-body">
                              <a href="{{ route('employee.payments.studentDetailPayment', [$student->nisn, $item->name]) }}" class="btn {{ $item->isComplete ? 'btn-success' : 'btn-primary' }} btn-action mr-1">
